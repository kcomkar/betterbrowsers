...
/**
 * This class is used to add cache control information to the response. For get messages no caching should be done.
 * @author D049641
 *
 */
public class CacheControlResponseHandler implements ResponseHandler {
